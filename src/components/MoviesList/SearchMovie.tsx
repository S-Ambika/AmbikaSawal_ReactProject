...
const SearchMovie = ({Title, Poster, imdbRating, Rated, Runtime, Genre, Plot}) => {
    return (
        <Row>
            <Col span={11}>
                <img 
            ...
            <Layout className="layout">
                <Header>
                    <div style={{ textAlign: 'center'}}>
                        <TextTitle style={{color: '#ffffff', marginTop: '14px'}} level={3}>Welcome, Search Movie By Name</TextTitle>
                    </div>
                </Header>
                        ...
                        <Row gutter={16}  justify="center">
                            ...
                            { error !== null &&
                                <div style={{margin: '20px 0'}}>
                                    <Alert message={'Search By valid Name..'} type="error" />
                                </div>
                            }
